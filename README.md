...
> **📚 Documentation moved!** See [SYSTEM-OVERVIEW.md](./SYSTEM-OVERVIEW.md) for a quick intro, or browse [docs/](./docs/) for complete reference.  
> **🚀 New to the system?** Start with [docs/getting-started/quickstart.md](./docs/getting-started/quickstart.md)
